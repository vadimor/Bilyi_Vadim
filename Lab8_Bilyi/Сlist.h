...
*/
	...
	*/
	...
	Ccooperator* operator[] (int i);


	friend ostream& operator<< (ostream& output, Clist& obj);
	friend ofstream& operator<< (ofstream& output, Clist& obj);
	friend istream& operator>> (istream& input, Clist& obj);
	friend ifstream& operator>> (ifstream& input, Clist& obj);
